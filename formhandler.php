...
mail ('desmond.ballardo@seattlecollege.edu', $subject, $body, $from);

header('Location: thnx.html'); // replace "thx.html" with the name and path to your actual thank you page